...
const AddImages = ({ images, setImages }) => {
  ...
  useEffect(() => {
      const newImages = [{url: url1}, {url: url2}, {url: url3}, {url: url4}, {url: url5}]
      setImages(newImages)
  ...
  return (
    <div id={styles.imagesContainer}>
      ...
      <footer id={styles.footer}>
        ...
        <NavLink onClick={addToLocal} className={styles.navlink} to='/host/title-description'>Next</NavLink>
      </footer>
    </div>
  )
}
